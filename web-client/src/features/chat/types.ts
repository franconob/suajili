...
export type Message = components["schemas"]["com.francoherrero.ai_agent_multiplatform.model.Message"];
export type Role = components["schemas"]["com.francoherrero.ai_agent_multiplatform.model.Role"];
